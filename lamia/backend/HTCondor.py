import logging, os, shlex, copy, sys, subprocess
...
TODO: Detailed description
    ...
    def submit(self, jobName,
        ...
        L.debug("test of config:")
        L.debug("condor host = %s", self.cfg['CONDOR_HOST'])
...
class HTCondorBackendPy(lamia.backend.interface.BatchBackend):
    """
TODO: Short description
